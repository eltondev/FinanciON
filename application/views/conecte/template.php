...
<html lang="pt-br">
  ...
  <body>
    ...
    <!--Header-part-->
    <div id="header">
      <h1><a href="dashboard.html">FinanciON - Gestão Financeira</a></h1>
    </div>
    <!--close-Header-part--> 
    ...
    <!--Footer-part-->
    <div class="row-fluid">
      <div id="footer" class="span12">2014 &copy; |<a href="http://eltondev.com.br" target="_blank" title="EltonDEV - Soluçõs e Serviços"> <img src="<?php echo base_url();?>assets/img/eltonDev.png"/></div>
    </div>
