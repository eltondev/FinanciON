...
<head>
        <title>Login | FinanciON - Gestão Financeira</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo base_url()?>index.php/financion/verificarLogin">
            ...
            $(document).ready(function(){
                ...
                $("#formLogin").validate({
                   ...
                   submitHandler: function( form ){       
                        ...
                        $.ajax({
                          type: "POST",
                          url: "<?php echo base_url();?>index.php/financion/verificarLogin?ajax=true",
                          data: dados,
                          dataType: 'json',
                          success: function(data)
                          {
                            if(data.result == true){
                                window.location.href = "<?php echo base_url();?>index.php/financion";
                            }
                            else{
        ...
        <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-header">
            ...
            <h4 id="myModalLabel">FinanciON - Gestão Financeira</h4>
          </div>
