                    ...
                    <div class="invoice-head" style="margin-bottom: 0">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/financion/emitente">Configurar</a><<<</td>
                                </tr>
                                <?php } else {?>
                                <tr>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function Popup(data)
        {
            var mywindow = window.open('', 'FinanciON - Gestão Financeira', 'height=600,width=800');
