...
class financion extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('financion_model','',TRUE);
        
    }

    public function index() {
        if((!$this->session->userdata('session_id')) || (!$this->session->userdata('logado'))){
            redirect('financion/login');
        }

        $this->data['ordens'] = $this->financion_model->getOsAbertas();
        $this->data['produtos'] = $this->financion_model->getProdutosMinimo();
        $this->data['os'] = $this->financion_model->getOsEstatisticas();
        $this->data['estatisticas_financeiro'] = $this->financion_model->getEstatisticasFinanceiro();
        $this->data['menuPainel'] = 'Painel';
        $this->data['view'] = 'financion/painel';
    ...
    public function minhaConta() {
        ...
        $this->data['usuario'] = $this->financion_model->getById($this->session->userdata('id'));
        $this->data['view'] = 'financion/minhaConta';
        $this->load->view('tema/topo',  $this->data);
    ...
    public function alterarSenha() {
        ...
        $result = $this->financion_model->alterarSenha($senha,$oldSenha,$this->session->userdata('id'));
        if($result){
            $this->session->set_flashdata('success','Senha Alterada com sucesso!');
            redirect(base_url() . 'index.php/financion/minhaConta');
        }
        else{
    ...
    public function pesquisar() {
        ...
        $data['results'] = $this->financion_model->pesquisar($termo);
        $this->data['produtos'] = $data['results']['produtos'];
        $this->data['servicos'] = $data['results']['servicos'];
        $this->data['os'] = $data['results']['os'];
        $this->data['clientes'] = $data['results']['clientes'];
        $this->data['view'] = 'financion/pesquisa';
        $this->load->view('tema/topo',  $this->data);
    ...
    public function login(){
        ...
        $this->load->view('financion/login');
    ...
    public function emitente(){   
        ...
        $data['dados'] = $this->financion_model->getEmitente();
        $data['view'] = 'financion/emitente';
    ...
    public function cadastrarEmitente() {
        if((!$this->session->userdata('session_id')) || (!$this->session->userdata('logado'))){
            redirect('index.php/financion/login');
        }
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(base_url().'index.php/financion/emitente');
            ...
            $retorno = $this->financion_model->addEmitente($nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf,$telefone,$email, $logo);
            if($retorno){
    ...
    public function editarEmitente() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->financion_model->editEmitente($id, $nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf,$telefone,$email);
            if($retorno){
    ...
    public function editarLogo(){
        ...
        $retorno = $this->financion_model->editLogo($id, $logo);
        if($retorno){
